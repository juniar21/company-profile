      ...
      <div className="mx-auto">
        <div className="p-4 mt-[-16px]">
          ...
          <div className="md:mt-[90px] md:gap-3 md:w-[500px] lg:w-full w-[300px] flex flex-col  gap-2 lg:gap-6 mx-auto mt-[350px] items-center content-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3>
                ...
                Integer vel sem <br /> egestas, aliquam ante eget, vulputate
                neque. Nam quam enim, ultricies id convallis <br /> blandit,
                varius nec dui. Integer vel sem egestas, aliquam ante eget,
                vulputate neque.
              </h3>
              <div className="flex flex-col gap-5">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h4>
                      Nam quam enim, ultricies id convallis blandit, varius nec
                      dui. <br />
                      Integer vel sem egestas, aliquam ante eget, vulputate
                      neque.
                    </h4>
                  </div>
                </div>
          ...
          <div className="flex flex-col gap-2 items-center content-center mt-[90px]">
            ...
            <p className="text-black text-[33px] font-bold">
              {" "}
              People say About Us
            </p>
            <Carousel
